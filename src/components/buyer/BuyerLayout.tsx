    ...
    <div className="flex h-screen flex-col overflow-hidden bg-[var(--b2-soft)] text-[var(--b1)]">
      ...
      <div className="relative flex min-h-0 flex-1 pt-[68px]">
        <motion.div
          ...
          initial={false}
          animate={{
            width: collapsed ? BUYER_SIDEBAR_WIDTH_COLLAPSED : BUYER_SIDEBAR_WIDTH_EXPANDED,
          }}
          transition={{ type: "spring", stiffness: 380, damping: 38 }}
          ...
          >
            <div className="space-y-6">
              <DashboardPageTopBar
                ...
                rightSlot={<BuyerNotificationsBell />}
              />
              {children}
            </div>
          </motion.main>
